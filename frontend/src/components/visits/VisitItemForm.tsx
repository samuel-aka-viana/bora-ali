...
export function VisitItemForm({ value, onChange, nameError }: Props) {
  ...
  return (
    <div className="border border-border rounded-xl bg-background p-3 space-y-3" data-testid="visit-item-form">
      <Input
